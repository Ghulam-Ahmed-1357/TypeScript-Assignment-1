...
modified_list.sort();
console.log("Alphabetical order after sorting in alphabetical order:", modified_list);
// original order
...
console.log("Original Order After Double Reverse:", locationsOfPlacesToVisit.reverse());
